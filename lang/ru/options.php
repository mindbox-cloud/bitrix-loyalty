...
$MESS['MINDBOX_LOYALTY_SECRET_KEY'] = 'Секретный ключ';
$MESS['MINDBOX_LOYALTY_SECRET_KEY_HINTS'] = 'Секретный ключ';

$MESS['MINDBOX_LOYALTY_WEBSITE_PREFIX'] = 'Префикс для операций';
$MESS['MINDBOX_LOYALTY_WEBSITE_PREFIX_HINTS'] = 'Префикс для операций';

$MESS['MINDBOX_LOYALTY_BRAND'] = 'Бренд';
$MESS['MINDBOX_LOYALTY_BRAND_HINTS'] = 'Бренд';

$MESS['MINDBOX_LOYALTY_DISABLE_PROCESSING_USER_GROUPS'] = 'Ограничения процессинга';
$MESS['MINDBOX_LOYALTY_DISABLE_PROCESSING_USER_GROUPS_HINTS'] = 'Используйте эту настройку, чтобы исключить служебных пользователей из процессинга заказов. Например, при синхронизации с 1С.';
...
$MESS['MINDBOX_LOYALTY_TIMEOUT'] = 'Таймаут';
$MESS['MINDBOX_LOYALTY_TIMEOUT_HINTS'] = 'Таймаут';

$MESS['MINDBOX_LOYALTY_IS_LOGGING'] = 'Включить логирование';
$MESS['MINDBOX_LOYALTY_IS_LOGGING_HINTS'] = 'При включенном функционале будут сохраняться данные запросов и ответы на них.';

$MESS['MINDBOX_LOYALTY_LOG_PATH'] = 'Путь до хранения логов';
$MESS['MINDBOX_LOYALTY_LOG_PATH_HINTS'] = 'Укажите абсолютный путь к файлам лога. Не забудьте закрыть указанный путь для внешнего вмешательства';

$MESS['MINDBOX_LOYALTY_LOG_LIFE_TIME'] = 'Время хранения файлов логов';
$MESS['MINDBOX_LOYALTY_LOG_LIFE_TIME_HINTS'] = 'Укажите за сколько дней сохранять логи. Укажите 0, чтобы агент не удалял логи.';

$MESS['MINDBOX_LOYALTY_TEST_MODE'] = 'Тестовый режим';
$MESS['MINDBOX_LOYALTY_TEST_MODE_HINTS'] = 'Добавляет к передаваемым идентификаторам префик test-';

$MESS['MINDBOX_LOYALTY_EXTERNAL_PRODUCT'] = 'Идентификатор продукта';
$MESS['MINDBOX_LOYALTY_EXTERNAL_PRODUCT_HINTS'] = 'Укажите название идентификатора продукта в системе mindbox';
...
$MESS['MINDBOX_LOYALTY_YML_CATALOG_IBLOCK_ID'] = 'Идентификатор инфоблока каталога';
$MESS['MINDBOX_LOYALTY_YML_CATALOG_IBLOCK_ID_HINTS'] = 'Укажите идентификатор инфоблока каталога';

$MESS['MINDBOX_LOYALTY_YML_BASE_PRICE_ID'] = 'Тип базовой цены';
$MESS['MINDBOX_LOYALTY_YML_BASE_PRICE_ID_HINTS'] = 'Выбор типа цены, которая будет считаться базовой';

$MESS['MINDBOX_LOYALTY_YML_PROTOCOL'] = 'Использовать в фиде протокол https';
$MESS['MINDBOX_LOYALTY_YML_PROTOCOL_HINTS'] = 'Укажите для проставлнеия в фиде https';

$MESS['MINDBOX_LOYALTY_YML_PATH'] = 'Путь до YML фида';
$MESS['MINDBOX_LOYALTY_YML_PATH_HINTS'] = 'Укажите путь относительно $["DOCUMENT_ROOT"] с названием файла в формате yml';
