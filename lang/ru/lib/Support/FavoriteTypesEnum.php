...
$MESS['MINDBOX_LOYALTY_FAVORITE_TYPE_SERIALIZE'] = 'Сериализованный массим в пользовательском поле';
$MESS['MINDBOX_LOYALTY_FAVORITE_TYPE_IBLOCK_ELEMENTS'] = 'Привязка к элементам инфоблока';
